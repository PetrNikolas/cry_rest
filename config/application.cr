...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Cry Rest web application."
  #
  #
  ...
  #
  # settings.secret_key_base= L5GjQv6CT_DlNiwb73rJ2sjePf5urr0jZWGdMhErKGw
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("cry_rest.log", "w"))
  #
  #
end
